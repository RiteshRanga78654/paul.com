...
export default function EventDetailPage() {
  ...
  if (loading) {
    return (
      ...
      >
        <p style={{ color: "#b79662", fontSize: "1.2rem" }}>
  ...
  const bannerUrl = rawBanner.startsWith("http")
    ? rawBanner
    : `https://uat-service.ireedindia.com/image/${rawBanner.replace(
        /^\/+|^image\//,
        ""
      )}`;
      ...
      >
        ...
        >
          <img
            ...
            onError={(e) =>
              (e.target.src =
                "https://via.placeholder.com/1200x450?text=Event+Banner")
            }
          />
        ...
        <style jsx>{`
          .banner-container {
            height: 450px; /* Desktop (unchanged) */
          }
        ...
        <div style={{ display: "flex", gap: "40px", flexWrap: "wrap" }}>
            ...
            <div style={cardStyle}>
              ...
              <div
                dangerouslySetInnerHTML={{
                  __html: event.content || "No description available.",
                }}
          ...
          <div style={{ flex: "0 0 350px", minWidth: "300px" }}>
            <div style={{ ...cardStyle, position: "sticky", top: "30px" }}>
              <h3
                style={{
                  ...sectionTitleStyle,
                  textAlign: "center",
        ...
        >
          ...
          <img
            ...
            style={{
              ...
              boxShadow: "0 0 50px rgba(183, 150, 98, 0.2)",
            }}
          />
