...
const services = [
  {
    id: "01",
    title: "Campus & Corporate Training",
  ...
  {
    id: "03",
    title: "PAN India Franchise & Quality Audits",
    icon: Briefcase,
  },
  {
    id: "04",
    title: "Online Learning & Event Based Skilling",
    icon: ShieldCheck,
  },
  {
    id: "05",
    title: "Planning, Strategy & Consortium Programs",
    icon: BarChart3,
  },
  {
    id: "06",
    title: "PMC Reporting & Optimization",
    icon: CheckCircle2,
  },
];
        ...
        <section className="relative min-h-[90vh] flex items-center bg-black overflow-hidden font-sans">
          ...
          <div className="container mx-auto px-6 lg:px-12 relative z-10 flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-3/5 space-y-8">
              ...
              >
                IREED India focuses on advancing real estate education, skill
                development and building professional network in India. IREED's
                mission is to foster precise, high-quality training and build
                network of emerging developers for real estate excellence.
              </motion.p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex bg-[#4c4949] p-8 rounded-xl border border-gray-600 hover:border-[#b79662] transition-all duration-300 shadow-lg group hover:-translate-y-1">
                ...
                <div>
                  ...
                  <p className="text-gray-200 text-sm leading-relaxed font-light">
                    Access to India's pioneering real estate education platform
                    with developer tie-ups, university affiliations, and
              ...
              <div className="flex bg-[#4c4949] p-8 rounded-xl border border-gray-600 hover:border-[#b79662] transition-all duration-300 shadow-lg group hover:-translate-y-1">
                ...
                <div>
                  ...
                  <p className="text-gray-200 text-sm leading-relaxed font-light">
                    Centralized resources for industry insights, career
                    guidance, and networking to drive business growth and
                    innovation.
                  </p>
                </div>
              </div>
              ...
              <div className="flex bg-[#4c4949] p-8 rounded-xl border border-gray-600 hover:border-[#b79662] transition-all duration-300 shadow-lg group hover:-translate-y-1">
                ...
                <div>
                  ...
                  <p className="text-gray-200 text-sm leading-relaxed font-light">
                    Direct pathways for talent acquisition through job fairs,
                    internships, and collaborations with 100+ industry partners.
                  </p>
                </div>
              </div>
              ...
              <div className="flex bg-[#4c4949] p-8 rounded-xl border border-gray-600 hover:border-[#b79662] transition-all duration-300 shadow-lg group hover:-translate-y-1">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-white group-hover:text-[#b79662] transition-colors">
                    Education Partner Role
                  </h3>
                  <p className="text-gray-200 text-sm leading-relaxed font-light">
                    Specialized skilling programs tailored to real estate
                    demands, bridging academic training with practical workforce
                    needs.
                  </p>
                </div>
              </div>
