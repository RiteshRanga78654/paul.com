...
`,
  ...
  const servicesData = [
    {
      ...
      description: `We deliver structured, outcome-driven real estate training and workshops for organisations. Our programs combine industry experience with practical frameworks that help participants develop market-ready skills and strategic competence. Who this is for: Real estate professionals, sales leaders, channel partners, corporate teams, and career entrants seeking credible real estate education and certification.`,
    },
    {
      title: "Hiring and Placement",
      image:
  ...
  return (
    <>
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-center order-2 lg:order-2 space-y-6">
              ...
              <div className="space-y-2">
                <p className="text-white text-base sm:text-lg md:text-xl">
                  ...
                  Mentor & Author for Leaders & Founders
                </p>
                <h3 className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">
                  Build. Scale. Lead.
                </h3>
      ...
      <section className="bg-white py-16 px-4 sm:px-6 lg:px-8 mt-[20px] mb-[20px] lg:mt-[-28px]">
        <h2 className="text-3xl text-center md:text-4xl font-bold text-[#b79662]">
          Our <span className="text-[#b79662]">Services</span>
        </h2>
        <div className="w-24 h-1 bg-[#b79662] mx-auto mt-4 mb-10 rounded-full"></div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
            ...
            <div className="lg:col-span-3 flex flex-col gap-12">
              {/* Small Video 1 */}
              <div className="relative aspect-video rounded-2xl overflow-hidden shadow-lg border-2 border-gray-50 group">
                <iframe
                  className="absolute top-0 left-0 w-full h-full"
