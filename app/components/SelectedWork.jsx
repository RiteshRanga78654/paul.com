...
const ProjectCard = ({ project }) => {
  ...
  return (
    <motion.div
      // Background set to theme dark gray #4c4949
      className="relative w-[80vw] md:w-[290px] h-[350px] md:h-[400px] flex-shrink-0 cursor-pointer mr-5 snap-start overflow-hidden bg-[#4c4949]"
    ...
    >
      ...
      <motion.div
        // Changed Expanding Box color from Red to Gold (#b79662)
...
const SelectedWork = () => {
  ...
  return (
    // Section Background changed to #1e1e1e (Dark Theme)
