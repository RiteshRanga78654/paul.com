    ...
    <div className="bg-[#4c4949] rounded-xl overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-[#b79662]/20 hover:-translate-y-2 transition-all duration-300 border border-gray-600 group flex flex-col h-full">
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <a 
          ...
          className="inline-flex items-center justify-center bg-[#b79662] hover:bg-[#967d51] text-white font-semibold py-2.5 px-5 rounded transition-colors duration-300 w-full md:w-auto text-sm  tracking-wide mt-auto"
        >
          Read Blog
        </a>
      </div>
